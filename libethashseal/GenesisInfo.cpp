...
#include "genesis/AnomalyMainNetwork.cpp"
#include "genesis/AnomalyTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::AnomalyMainNetwork: return c_genesisInfoAnomalyMainNetwork;
	case Network::AnomalyTestNetwork: return c_genesisInfoAnomalyTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::AnomalyMainNetwork: return c_genesisStateRootAnomalyMainNetwork;
	case Network::AnomalyTestNetwork: return c_genesisStateRootAnomalyTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
